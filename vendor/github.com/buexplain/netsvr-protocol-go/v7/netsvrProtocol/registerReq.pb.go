...
// 业务进程向网关请求，注册自己
// 注册逻辑：检查注册条件后，会给业务进程的连接异步写入注册成功的信息、将业务进程的连接注册到管理器，让业务进程的连接接收网关转发的客户端的websocket消息，如果注册失败，会返回注册失败的信息
type RegisterReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// 表示业务进程可以接收的事件，如果要接收多个，则按位或，具体的枚举值可以查看event.proto
...
var file_registerReq_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x22, 0x25, 0x0a, 0x0b, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x3f,
