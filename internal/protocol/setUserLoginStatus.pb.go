...
type SetUserLoginStatus struct {
	...
	// 存储到网关的客户信息，登录成功会使用该值进行设置，登录失败会强制设置空字符串
	UserInfo string `protobuf:"bytes,3,opt,name=userInfo,proto3" json:"userInfo,omitempty"`
	// 客户在业务系统中的唯一id，该值只在设置登录状态的时候存储到网关中，其它任何时候都是只读
...
var file_setUserLoginStatus_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x9c, 0x01, 0x0a, 0x12, 0x53, 0x65, 0x74, 0x55, 0x73, 0x65,
