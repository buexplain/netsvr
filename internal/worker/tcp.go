...
func (r *Server) Start() {
	...
	for {
		...
		default:
			...
			c.RegisterCmd(protocol.Cmd_TotalUniqIds, cmd.TotalUniqIds)
			c.RegisterCmd(protocol.Cmd_TopicUniqIds, cmd.TopicUniqIds)
			c.RegisterCmd(protocol.Cmd_TopicsUniqIdCount, cmd.TopicsUniqIdCount)
